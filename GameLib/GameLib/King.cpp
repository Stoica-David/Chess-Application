...
{
	return ((std::abs(p2.first - p1.first) == 1 && std::abs(p2.second - p1.second) == 0) || (std::abs(p2.first - p1.first) == 0 && std::abs(p2.second - p1.second) == 1) || ((std::abs(p2.first - p1.first) == 1 && std::abs(p2.second - p1.second) == 1)));
}
